...
for file in l1_spectral_library.h l1_name.h l1_sample_id.h l1_number_wavelengths.h l1_minimum_wavelength.h l1_maximum_wavelength.h
do
...
for file in l1_spectral_library.h l1_name.h  
do
	sed -i 's/;/\";/' $file
	sed -i 's/=\ /=\ \"/' $file
done
